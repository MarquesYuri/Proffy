...
import giveClassesBgImagery from '../../assets/images/give-classes-background.png'
...
function GiveClasses() {
  ...
  return (
    <View style={ styles.container }>
      <ImageBackground resizeMode='contain' source={ giveClassesBgImagery } style={ styles.content } >
